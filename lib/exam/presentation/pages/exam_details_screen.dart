...
class ExamDetailsScreen extends GetView<ExamDetailsViewModel> {
  const ExamDetailsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(ExamDetailsViewModel());

    // var tmp =
    //     DateTime.parse(controller.examDetails!.createdAt!);
            ...
            body: Obx(() {
              switch (controller.rxRequestStatus.value) {
                ...
                case ApiStatus.completed:
                  if (controller.examDetails?.questionsData == null ||
                      controller.examDetails?.questionsData?.isEmpty == true) {
                    return const Center(
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: (controller.examDetails != null)
                                ? Padding(
                                                        ...
                                                        children: [
                                                          ...
                                                          TextSpan(
                                                            text: controller
                                                                ...
                                                                .toString(),
                                                            //controller.examDetails?.totalQuestions .toString(),
                                                            style: getTextStyle(
                                                                14,
                                                                FontWeight.w400,
                                                                Colors.white),
...
class _QuestionsAndAnswerScreenState extends State<QuestionsAndAnswerScreen>
  ...
  Obx buildSliverList(ExamDetailsViewModel homeController) {
    return Obx(() {
      switch (homeController.rxRequestStatus.value) {
        ...
        case ApiStatus.completed:
          if (homeController.examDetails?.questionsData == null ||
              homeController.examDetails?.questionsData?.isEmpty == true) {
            return const SliverToBoxAdapter(
              child: Center(
                child: Text(MessageConstant.noDataMessage),
              ),
            ...
            return SliverList(
              delegate: SliverChildBuilderDelegate(
                childCount: homeController.examDetails?.questionsData?.length,
  ...
  Widget buildQAListItem(ExamDetailsViewModel homeController, int index) {
    var questionList = homeController.examDetails!.questionsData;

    var pwdWidgets = <Widget>[];
    if (controller.examDetails?.questionsData![index].comments.isBlank ==
        false) {
      for (var comment
          in controller.examDetails!.questionsData![index].comments!) {
              ...
              child: Row(
                ...
                children: [
                  InkWell(
                    onTap: () {
                      if (homeController
                              .examDetails!.questionsData![index].explanation !=
                          null) {
                        // Get.defaultDialog(
                        //   title: "Explanation",
                        ...
                        //         child: Html(
                        //           data: homeController.examDetails!
                  ...
                  InkWell(
                    onTap: () {
                      if (homeController.examDetails!.questionsData![index]
                              .comments?.isBlank ==
                          false) {
                        Get.defaultDialog(
                            title: "Comments",
              ...
              SliverGrid(
                  ...
                  delegate: SliverChildBuilderDelegate(
                    ...
                    return Container(
                      ...
                      width: 40,
                      decoration: BoxDecoration(
                          color: controller.examDetails!.questionsData![index]
                                      .isCorrect ==
                                  true
                              ? Colors.green
                              : Colors.red),
                      ...
                      childCount:
                          homeController.examDetails?.questionsData?.length));
      }
    });
  }
}
