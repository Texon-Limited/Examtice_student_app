...
import 'package:examtice_teacher/subscriptions/pages/subscription_details_screen.dart';
...
class SubscriptionScreen extends GetView<SubscriptionViewModel> {
  ...
  Obx buildSubscribeStudentsListSection(SubscriptionViewModel controller) {
    return Obx(() {
      switch (controller.rxRequestStatus.value) {
        case ApiStatus.loading:
          return const SliverToBoxAdapter(
                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //     fit: BoxFit.fitWidth,
                        //     imageUrl:
                        //     '${AppUrls.pictureUrl}${controller.allSubscriptionItemList[index].}',
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                controller.allSubscriptionItemList[index].planName
                                    .toString(),
                                style: getTextStyle(16, FontWeight.w600,
                                    ColorManager.brandColor),
                              ),
                              // Text(
                              //   controller.allSubscriptionItemList[index].description
                              //       .toString(),
                              //   style: getTextStyle(
                              //       14,
                              //       FontWeight.w400,
                                ...
                                children: [
                                  ...
                                  Text(
                                      DateFormat
                                          .yMMMMd()
                                          .format(controller
                                          .allSubscriptionItemList[index].createdAt!)
                                          .toString()
                                    // style: getTextStyle(14, FontWeight.w400,
                                    //     ColorManager.brandColor),
                                  ),
                                ...
                                children: [
                                  ...
                                  Text(
                                      DateFormat
                                          .yMMMMd()
                                          .format(controller
                                          .allSubscriptionItemList[index].nextSubscriptionDate!)
                                          .toString(),
                                    // style: getTextStyle(14, FontWeight.w400,
                                    //     ColorManager.brandColor),
                                  ),
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    '${getCurrency()} ${controller.allSubscriptionItemList[index].planAmount}/Anually',
                                    // style: getTextStyle(14, FontWeight.w400,
                                    //     ColorManager.brandColor),
                                  ),
                                  InkWell(
                                    onTap: (){
                                      controller.setSelectedExam(controller.allSubscriptionItemList[index]);
